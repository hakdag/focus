...
namespace #projectname#.Controllers
{
    public class BaseController<TBusiness, TModel> : ApiController where TBusiness : IBaseBusiness<TModel>
    {
        ...
        public PageResult<TModel> Get(string searchProperty, string sortPropertyDefault, string filterQuery, int startIndex, int rowsOnPage, string sortBy, string sortOrder)
        {
    ...
    public class BaseControllerLogs<TBusiness, TModel> : ApiController where TBusiness : IBaseBusinessLogs<TModel>
    {
        protected TBusiness business;

        public BaseControllerLogs(TBusiness business)
        {
            this.business = business;
        }
